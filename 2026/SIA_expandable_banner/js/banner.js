...
Banner.slider = function(){
  ...
  var player;
  player = new MediaElement('player', {width: 322});

  var currentIdx = 0;

  document.getElementById('player').play();

  var moveSlide = function(current, player){
  ...
  pager1.addEventListener('click', function(){
    pager.children[1].className = ' ';
    pager.children[2].className = ' ';
    this.className = 'active';
    moveSlide(0, player);
  });

  pager2.addEventListener('click', function(){
    pager.children[0].className = ' ';
    pager.children[2].className = ' ';
    this.className = 'active';
    moveSlide(1, player);
  });
  ...
  navPrev.addEventListener('click', function(){
    ...
    switch(currentIdx){
      case 0:
          ...
          pager.children[0].className = ' ';
          pager.children[1].className = ' ';
          pager.children[2].className = 'active';
          break;
      case 1:
          currentIdx = 0;
      ...
      case 2:
          currentIdx = 1;
          pager.children[0].className = ' ';
          pager.children[1].className = 'active';
          pager.children[2].className = ' ';
